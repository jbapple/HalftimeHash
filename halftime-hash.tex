...
The goals are a low collisions of (different inputs that produce identical output hash values), high performance, and portability -- HalftimeHash should be easy to implement correctly on new ISAs and easy to code in almost any programming language.
