...
% TODO: we also need some additional notion of independence for the $k$ tree hashes?
...
%%     & remainder &  & $bdi_wk$ \\
%%     % TODO: put these show-your-work in an appendix
%%     \hline
%%   \end{tabular}
...
%%   d}
%% \end{table*}
% TODO: matrix determinant requirements
...
\subsection{HalftimeHash, in total}
