...
\captionof{figure}{
  \label{smhasher-speed}
    Some variants of HalftimeHash are faster than the fastest hash functions in the SMhasher suite, even ones that come with no AU guarantees. \protect\cite{smhasher}
    MeowHash128 and xxh128 produce 128 output bits, all other SMhasher functions produce 64 bits.
    HalftimeHash24 produces 192 output bits, HalftimeHash32 produces 256 bits, and HalftimeHash40 produces 320 bits.
}
